...
tags: [NLP, Speech Moderation, Realtime, Whisper, Wav2Vec2, DistilBERT]
date: 2025-08-25
...
With wav2vec2, average end-to-end latency is **under 400 ms**. With Whisper, it’s **\~1.1 to 1.8 s** but the text is cleaner.
